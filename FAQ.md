...
If you don't have the permission to do this, set the `limitOpenFilesOnRemote`
option in your config. See [configuration](./docs/configuration.md).
...
Set the `context` property to the folder whose contents should be uploaded
directly, for example `./build`.
