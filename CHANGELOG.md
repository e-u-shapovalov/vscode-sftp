...
## 2.8.3 — where the operation log goes, and a speed pass · куда попадает журнал операций, и работа над скоростью
