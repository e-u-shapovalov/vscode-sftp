...
Последний релиз добавляет команду **«Показать дерево»**, которая строит ASCII-дерево папки на сервере или локально — при необходимости с размерами файлов и ограничением глубины — и открывает его в текстовой вкладке из контекстного меню папки. Также в этом релизе обновлена и расширена документация.
