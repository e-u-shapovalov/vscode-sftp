...
| `wireferry.operationLog` | `tab` | Куда попадает журнал выгрузки/скачивания/удаления: `tab` (новая вкладка редактора), `output` (канал вывода WireFerry — без вкладки и без смены фокуса) или `off` |
